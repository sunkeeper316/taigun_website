    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div>
        ...
        <ul class="space-y-2">
          ...
          <li>
            <a href="https://www.taigun.sbs/privacy/privacy_policy_zh_tw.html" target="_blank" rel="noopener noreferrer" class="text-sm text-gray-400 hover:text-indigo-500 transition duration-300">隱私權政策</a>
          </li>
        </ul>
      </div>
